...
const menuItems = [
  { name: "Dashboard", path: "/projects", icon: "/sidebar_icons.svg" },
  { name: "Project", path: "/", icon: "/sidebar_icons2.svg" },
...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const linkClass = ({ isActive }) =>
    `flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300
     ${isActive ? "bg-red-50 text-[#202020] shadow-sm" : "text-[#202020] hover:bg-gray-100"}`;
...
`}
      >
        ...
        <div className="p-5 h-22 flex items-center shrink-0 border-b border-gray-50">
          <img src="/Logo.svg" className="h-[75px] w-[216px] object-contain" alt="logo" />
        </div>
        <div
          ref={scrollRef}
        ...
        >
          ...
          <div className="mt-8 mb-4">
            <div className="bg-[#FFF6F6] rounded-[14px] p-4 space-y-3 relative border border-red-50">
              <button className="absolute right-1 top-3.5 w-5 h-5 flex items-center justify-center rounded-full shadow-sm text-red-600  transition-colors">
                <span className="text-[14px]"><img src="/edit.svg" alt="" /></span>
              </button>
              <span className="font-semibold text-[#202020]"> Organization Details</span>
              ...
              <div className="mt-3 pt-3 border-t border-red-100/50 space-y-2 text-[12px] text-gray-700">
                ...
                <p><span className="font-semibold text-[#202020]">State:</span> Maharashtra</p>
                <p><span className="font-semibold text-[#202020]">GST:</span> XXXXXXXXXX</p>
                <p><span className="font-semibold text-[#202020]">PAN:</span> XXXXXXXXX</p>
              </div>
            </div>
          </div>
        </div>
